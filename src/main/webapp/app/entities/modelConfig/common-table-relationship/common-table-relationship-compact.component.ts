...
import CommonTableRelationshipUpdate from '@/entities/modelConfig/common-table-relationship/common-table-relationship-update.vue';
...
export default class CommonTableRelationshipCompactComponent extends Vue {
  ...
  public commonTableRelationshipCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.commonTableRelationshipService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.modelConfigCommonTableRelationship.deleted', {
          param: this.removeId,
        }).toString();
