      ...
      .then(values => {
        ...
        if (that.commonTableField.id) {
          this.commonTableFieldService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.modelConfigCommonTableField.updated', {
                param: param.data.id,
              }).toString();
          ...
          this.commonTableFieldService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.modelConfigCommonTableField.created', {
                param: param.data.id,
              }).toString();
