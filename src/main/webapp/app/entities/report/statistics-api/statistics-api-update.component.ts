      ...
      .then(values => {
        ...
        if (that.statisticsApi.id) {
          this.statisticsApiService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.statisticsStatisticsApi.updated', { param: param.data.id }).toString();
          ...
          this.statisticsApiService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.statisticsStatisticsApi.created', { param: param.data.id }).toString();
