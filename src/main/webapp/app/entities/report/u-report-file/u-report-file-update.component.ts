...
export default class UReportFileUpdate extends Vue {
  ...
  public save(): void {
    ...
    if (this.uReportFile.id) {
      this.uReportFileService()
        ...
        .subscribe(param => {
          this.isSaving = false;
          const message = this.$t('jhipsterSampleApplicationApp.reportUReportFile.updated', { param: param.data.id }).toString();
      ...
      this.uReportFileService()
        ...
        .subscribe(param => {
          this.isSaving = false;
          const message = this.$t('jhipsterSampleApplicationApp.reportUReportFile.created', { param: param.data.id }).toString();
