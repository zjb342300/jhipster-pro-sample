...
@Component
export default class UReportFileCompactComponent extends Vue {
  ...
  public uReportFileCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.uReportFileService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.reportUReportFile.deleted', { param: this.removeId }).toString();
