      ...
      .then(values => {
        ...
        if (that.commonConditionItem.id) {
          this.commonConditionItemService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.reportCommonConditionItem.updated', {
                param: param.data.id,
              }).toString();
          ...
          this.commonConditionItemService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.reportCommonConditionItem.created', {
                param: param.data.id,
              }).toString();
