      ...
      .then(values => {
        ...
        if (that.commonCondition.id) {
          this.commonConditionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.commonQueryCommonQuery.updated', { param: param.data.id }).toString();
          ...
          this.commonConditionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.commonQueryCommonQuery.created', { param: param.data.id }).toString();
