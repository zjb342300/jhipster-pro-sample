...
export default class UploadImageCompactComponent extends Vue {
  ...
  public uploadImageCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.uploadImageService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.filesUploadImage.deleted', { param: this.removeId }).toString();
