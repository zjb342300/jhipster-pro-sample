      ...
      .then(values => {
        ...
        if (that.uploadImage.id) {
          this.uploadImageService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesUploadImage.updated', { param: param.data.id }).toString();
          ...
          this.uploadImageService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesUploadImage.created', { param: param.data.id }).toString();
