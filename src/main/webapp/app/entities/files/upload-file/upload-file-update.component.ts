      ...
      .then(values => {
        ...
        if (that.uploadFile.id) {
          this.uploadFileService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesUploadFile.updated', { param: param.data.id }).toString();
          ...
          this.uploadFileService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesUploadFile.created', { param: param.data.id }).toString();
