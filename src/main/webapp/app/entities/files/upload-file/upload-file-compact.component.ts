...
export default class UploadFileCompactComponent extends Vue {
  ...
  public uploadFileCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.uploadFileService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.filesUploadFile.deleted', { param: this.removeId }).toString();
