      ...
      .then(values => {
        ...
        if (that.ossConfig.id) {
          this.ossConfigService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesOssConfig.updated', { param: param.data.id }).toString();
          ...
          this.ossConfigService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesOssConfig.created', { param: param.data.id }).toString();
