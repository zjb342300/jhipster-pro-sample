      ...
      .then(values => {
        ...
        if (that.smsConfig.id) {
          this.smsConfigService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesSmsConfig.updated', { param: param.data.id }).toString();
          ...
          this.smsConfigService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesSmsConfig.created', { param: param.data.id }).toString();
