      ...
      .then(values => {
        ...
        if (that.resourceCategory.id) {
          this.resourceCategoryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesResourceCategory.updated', { param: param.data.id }).toString();
          ...
          this.resourceCategoryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.filesResourceCategory.created', { param: param.data.id }).toString();
