...
export default class ResourceCategoryCompactComponent extends Vue {
  ...
  public resourceCategoryCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.resourceCategoryService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.filesResourceCategory.deleted', { param: this.removeId }).toString();
