...
@Component
export default class ApiPermissionComponent extends Vue {
  ...
  public removeById(removeId: number): void {
    this.apiPermissionService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.systemApiPermission.deleted', { param: this.removeId }).toString();
  ...
  public editEntity(row: IApiPermission): void {
