      ...
      .then(values => {
        ...
        if (that.apiPermission.id) {
          this.apiPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.systemApiPermission.updated', { param: param.data.id }).toString();
          ...
          this.apiPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.systemApiPermission.created', { param: param.data.id }).toString();
