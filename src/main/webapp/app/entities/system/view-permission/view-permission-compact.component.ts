...
export default class ViewPermissionCompactComponent extends Vue {
  ...
  public viewPermissionCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public removeById(removeId: number): void {
    this.viewPermissionService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.systemViewPermission.deleted', { param: this.removeId }).toString();
