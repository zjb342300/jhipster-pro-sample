      ...
      .then(values => {
        ...
        if (that.viewPermission.id) {
          this.viewPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.systemViewPermission.updated', { param: param.data.id }).toString();
          ...
          this.viewPermissionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.systemViewPermission.created', { param: param.data.id }).toString();
