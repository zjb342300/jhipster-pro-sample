      ...
      .then(values => {
        ...
        if (that.gpsInfo.id) {
          this.gpsInfoService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsGpsInfo.updated', { param: param.data.id }).toString();
          ...
          this.gpsInfoService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsGpsInfo.created', { param: param.data.id }).toString();
