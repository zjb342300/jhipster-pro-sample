      ...
      .then(values => {
        ...
        if (that.administrativeDivision.id) {
          this.administrativeDivisionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsAdministrativeDivision.updated', {
                param: param.data.id,
              }).toString();
          ...
          this.administrativeDivisionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsAdministrativeDivision.created', {
                param: param.data.id,
              }).toString();
