...
@Component
export default class AdministrativeDivisionComponent extends Vue {
  ...
  public clickAdministrativeDivisionId;
  public searchValue = '';
  ...
  public loadAll(): void {
    ...
    const paginationQuery = {
      listModelName: 'AdministrativeDivision',
  ...
  public removeById(removeId: number): void {
    this.administrativeDivisionService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.settingsAdministrativeDivision.deleted', { param: this.removeId }).toString();
  ...
  public editEntity(row: IAdministrativeDivision): void {
    if (this.showInOther || this.editInModal) {
      this.administrativeDivisionId = row.id;
  ...
  public updateModalCancel(e) {
    this.administrativeDivisionId = null;
  ...
  public addChild(parent: IAdministrativeDivision): void {
    if (this.showInOther || this.editInModal) {
      this.updateModalVisible = true;
      this.parentId = parent.id;
    } else {
      // @ts-ignore
      this.$router.push({ name: 'settings-administrative-division-new', params: { parentId: parent.id }, append: true });
    }
  }
