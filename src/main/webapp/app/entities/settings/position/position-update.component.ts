      ...
      .then(values => {
        ...
        if (that.position.id) {
          this.positionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsPosition.updated', { param: param.data.id }).toString();
          ...
          this.positionService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsPosition.created', { param: param.data.id }).toString();
