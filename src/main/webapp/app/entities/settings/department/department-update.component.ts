      ...
      .then(values => {
        ...
        if (that.department.id) {
          this.departmentService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsDepartment.updated', { param: param.data.id }).toString();
          ...
          this.departmentService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsDepartment.created', { param: param.data.id }).toString();
