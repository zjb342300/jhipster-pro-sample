...
@Component
export default class BusinessTypeCompactComponent extends Vue {
  ...
  public businessTypeCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  public prepareRemove(instance: IBusinessType): void {
  ...
  public removeById(removeId: number): void {
    this.businessTypeService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhipsterSampleApplicationApp.settingsBusinessType.deleted', { param: this.removeId }).toString();
