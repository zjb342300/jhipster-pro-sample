      ...
      .then(values => {
        ...
        if (that.businessType.id) {
          this.businessTypeService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsBusinessType.updated', { param: param.data.id }).toString();
          ...
          this.businessTypeService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsBusinessType.created', { param: param.data.id }).toString();
