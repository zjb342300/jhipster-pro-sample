      ...
      .then(values => {
        ...
        if (that.dataDictionary.id) {
          this.dataDictionaryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsDataDictionary.updated', { param: param.data.id }).toString();
          ...
          this.dataDictionaryService()
            ...
            .subscribe(param => {
              that.isSaving = false;
              const message = this.$t('jhipsterSampleApplicationApp.settingsDataDictionary.created', { param: param.data.id }).toString();
