...
public class CommonLong implements Serializable, CommonField {
    ...
    public CommonLong ownerType(String ownerType) {
    ...
    public CommonLong ownerId(Long ownerId) {
    ...
    public CommonLong fieldName(String fieldName) {
