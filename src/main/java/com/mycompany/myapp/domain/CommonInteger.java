...
public class CommonInteger implements Serializable, CommonField {
    ...
    public CommonInteger id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public CommonInteger ownerType(String ownerType) {
    ...
    public CommonInteger ownerId(Long ownerId) {
    ...
    public CommonInteger fieldName(String fieldName) {
