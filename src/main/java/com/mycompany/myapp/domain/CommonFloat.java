...
public class CommonFloat implements Serializable, CommonField {
    ...
    public CommonFloat ownerType(String ownerType) {
    ...
    public CommonFloat ownerId(Long ownerId) {
    ...
    public CommonFloat fieldName(String fieldName) {
