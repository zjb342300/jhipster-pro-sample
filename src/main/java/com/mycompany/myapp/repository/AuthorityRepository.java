...
public interface AuthorityRepository extends JpaRepository<Authority, Long>, JpaSpecificationExecutor<Authority> {
    ...
    @Query(
        value = "select distinct authority from Authority authority left join fetch authority.users left join fetch authority.viewPermissions",
    ...
    @Query(
        "select authority from Authority authority left join fetch authority.users left join fetch authority.viewPermissions where authority.id =:id"
    )
