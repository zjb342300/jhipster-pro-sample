 ...
 * {@link com.mycompany.myapp.domain.CommonCondition}的DTO。
 */
...
public class CommonConditionDTO implements Serializable {
    ...
    private LinkedHashSet<CommonConditionItemDTO> items = new LinkedHashSet<>();
    ...
    public LinkedHashSet<CommonConditionItemDTO> getItems() {
        return items;
    }

    public void setItems(LinkedHashSet<CommonConditionItemDTO> items) {
        this.items = items;
    }
