...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.ViewPermission} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.ViewPermissionResource} to receive all the possible filtering options from
