...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.ApiPermission} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.ApiPermissionResource} to receive all the possible filtering options from
