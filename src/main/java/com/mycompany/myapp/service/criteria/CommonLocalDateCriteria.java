...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.CommonLocalDate} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.CommonLocalDateResource} to receive all the possible filtering options from
...
public class CommonLocalDateCriteria implements Serializable, Criteria {
    ...
    public LocalDateFilter value() {
        if (value == null) {
            value = new LocalDateFilter();
        }
        return value;
    }
