...
import com.mycompany.myapp.service.CommonTableRelationshipQueryService;
import com.mycompany.myapp.service.CommonTableRelationshipService;
 ...
 * 管理实体{@link com.mycompany.myapp.domain.CommonTableRelationship}的REST Controller。
 */
@RestController
@RequestMapping("/api")
    ...
    public ResponseEntity<List<CommonTableRelationshipDTO>> getAllCommonTableRelationships(
        ...
        if (listModelName != null) {
            if (commonQueryId != null) {
                ...
                page = commonTableRelationshipQueryService.selectByCustomEntity(listModelName, criteria, null, specification, pageable);
            } else {
                page = commonTableRelationshipQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
            }
        } else {
            if (commonQueryId != null) {
                Specification specification = commonConditionQueryService.createSpecification(commonQueryId);
                page = commonTableRelationshipQueryService.findBySpecification(specification, pageable);
            } else {
