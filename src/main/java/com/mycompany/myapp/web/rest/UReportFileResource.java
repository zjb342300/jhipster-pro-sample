...
public class UReportFileResource {
    ...
    public ResponseEntity<List<UReportFileDTO>> getAllUReportFiles(
        ...
        if (listModelName != null) {
            if (commonQueryId != null) {
                ...
                page = uReportFileQueryService.selectByCustomEntity(listModelName, criteria, null, specification, pageable);
            } else {
                page = uReportFileQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
            }
        } else {
            if (commonQueryId != null) {
                Specification specification = commonConditionQueryService.createSpecification(commonQueryId);
                page = uReportFileQueryService.findBySpecification(specification, pageable);
            } else {
                page = uReportFileQueryService.findByCriteria(criteria, pageable);
            }
        }
    ...
    public ResponseEntity<Void> exportToExcel() throws IOException {
        Page<UReportFileDTO> page = uReportFileService.findAll(Pageable.unpaged());
