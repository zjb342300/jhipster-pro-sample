    ...
    public ResponseEntity<List<BusinessTypeDTO>> getAllBusinessTypes(
        ...
        if (listModelName != null) {
            if (commonQueryId != null) {
                ...
                page = businessTypeQueryService.selectByCustomEntity(listModelName, criteria, null, specification, pageable);
            } else {
                page = businessTypeQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
            }
        } else {
            if (commonQueryId != null) {
                Specification specification = commonConditionQueryService.createSpecification(commonQueryId);
                page = businessTypeQueryService.findBySpecification(specification, pageable);
            } else {
