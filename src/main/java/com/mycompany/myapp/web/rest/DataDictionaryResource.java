    ...
    public ResponseEntity<List<DataDictionaryDTO>> getAllDataDictionaries(
        ...
        if (listModelName != null) {
            if (commonQueryId != null) {
                ...
                page = dataDictionaryQueryService.selectByCustomEntity(listModelName, criteria, null, specification, pageable);
            } else {
                page = dataDictionaryQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
            }
        } else {
            if (commonQueryId != null) {
                Specification specification = commonConditionQueryService.createSpecification(commonQueryId);
                page = dataDictionaryQueryService.findBySpecification(specification, pageable);
            } else {
