...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.ApiPermission}.
 */
@RestController
@RequestMapping("/api")
public class ApiPermissionResource {
    ...
    public ResponseEntity<List<ApiPermissionDTO>> getAllApiPermissions(
        ...
        if (listModelName != null) {
            page = apiPermissionQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
        } else {
