...
import com.mycompany.myapp.service.AdministrativeDivisionQueryService;
import com.mycompany.myapp.service.AdministrativeDivisionService;
import com.mycompany.myapp.service.CommonConditionQueryService;
import com.mycompany.myapp.service.criteria.AdministrativeDivisionCriteria;
 ...
 * 管理实体{@link com.mycompany.myapp.domain.AdministrativeDivision}的REST Controller。
 */
@RestController
@RequestMapping("/api")
    ...
    public ResponseEntity<List<AdministrativeDivisionDTO>> getAllAdministrativeDivisions(
        ...
        if (listModelName != null) {
            if (commonQueryId != null) {
                ...
                page = administrativeDivisionQueryService.selectByCustomEntity(listModelName, criteria, null, specification, pageable);
            } else {
                page = administrativeDivisionQueryService.selectByCustomEntity(listModelName, criteria, null, null, pageable);
            }
        } else {
            if (commonQueryId != null) {
                Specification specification = commonConditionQueryService.createSpecification(commonQueryId);
                page = administrativeDivisionQueryService.findBySpecification(specification, pageable);
            } else {
