...
class UserMapperTest {
    ...
    void userDTOsToUsersWithAuthoritiesStringShouldMapToUsersWithAuthoritiesDomain() {
        Set<AuthorityDTO> authorityDTOS = new LinkedHashSet<>();
        AuthorityDTO authorityDTO = new AuthorityDTO();
        authorityDTO.setCode(AuthoritiesConstants.ADMIN);
        ...
        assertThat(users.get(0).getAuthorities().iterator().next().getCode()).isEqualTo(AuthoritiesConstants.ADMIN);
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(user.getAuthorities().iterator().next().getCode()).isEqualTo(AuthoritiesConstants.ADMIN);
    }
