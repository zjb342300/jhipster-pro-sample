...
public class ResourceCategoryResourceIT {
     ...
     */
    public static ResourceCategory createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static ResourceCategory createUpdatedEntity(EntityManager em) {
    ...
    public void initTest() {
        resourceCategory = createEntity(em);
    }
    ...
    public void getAllResourceCategoriesByFilesIsEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.saveAndFlush(resourceCategory);
        UploadFile files = UploadFileResourceIT.createEntity(em);
        em.persist(files);
        em.flush();
    ...
    public void getAllResourceCategoriesByChildrenIsEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.saveAndFlush(resourceCategory);
        ResourceCategory children = ResourceCategoryResourceIT.createEntity(em);
        em.persist(children);
        em.flush();
    ...
    public void getAllResourceCategoriesByParentIsEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.saveAndFlush(resourceCategory);
        ResourceCategory parent = ResourceCategoryResourceIT.createEntity(em);
        em.persist(parent);
        em.flush();
    ...
    void putNewResourceCategory() throws Exception {
        ...
        em.detach(updatedResourceCategory);
