...
public class StatisticsApiResourceIT {
     ...
     */
    public static StatisticsApi createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static StatisticsApi createUpdatedEntity(EntityManager em) {
        StatisticsApi statisticsApi = new StatisticsApi()
            .title(UPDATED_TITLE)
    ...
    public void getAllStatisticsApis() throws Exception {
        ...
        statisticsApiRepository.saveAndFlush(statisticsApi);
    ...
    void putNewStatisticsApi() throws Exception {
        ...
        em.detach(updatedStatisticsApi);
