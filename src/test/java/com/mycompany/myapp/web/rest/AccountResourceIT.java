...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).ifPresent(authorities::add);
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).get());
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).get());
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).get());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        userService.updateUser(userMapper.userToAdminUserDTO(testUser4.get()));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singleton).get());
        ...
        assertThat(userDup.get().getAuthorities())
            ...
            // add by wang xin
            .containsExactly(authorityRepository.findFirstByCode(AuthoritiesConstants.USER).get());
    }
    ...
    public void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singleton).get());
