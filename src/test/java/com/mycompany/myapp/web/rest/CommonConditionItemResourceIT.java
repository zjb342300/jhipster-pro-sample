...
public class CommonConditionItemResourceIT {
     ...
     */
    public static CommonConditionItem createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CommonConditionItem createUpdatedEntity(EntityManager em) {
        CommonConditionItem commonConditionItem = new CommonConditionItem()
    ...
    public void initTest() {
        commonConditionItem = createEntity(em);
    }
    ...
    public void getAllCommonConditionItems() throws Exception {
        ...
        commonConditionItemRepository.saveAndFlush(commonConditionItem);
    ...
    public void getAllCommonConditionItemsByCommonConditionIsEqualToSomething() throws Exception {
        // Initialize the database
        commonConditionItemRepository.saveAndFlush(commonConditionItem);
        CommonCondition commonCondition = CommonConditionResourceIT.createEntity(em);
        em.persist(commonCondition);
        em.flush();
    ...
    void putNewCommonConditionItem() throws Exception {
        ...
        em.detach(updatedCommonConditionItem);
