...
public class OssConfigResourceIT {
     ...
     */
    public static OssConfig createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static OssConfig createUpdatedEntity(EntityManager em) {
        OssConfig ossConfig = new OssConfig()
    ...
    public void getAllOssConfigs() throws Exception {
        ...
        ossConfigRepository.saveAndFlush(ossConfig);
