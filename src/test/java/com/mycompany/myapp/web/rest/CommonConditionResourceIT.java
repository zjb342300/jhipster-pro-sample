...
public class CommonConditionResourceIT {
     ...
     */
    public static CommonCondition createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CommonCondition createUpdatedEntity(EntityManager em) {
        CommonCondition commonCondition = new CommonCondition()
            .name(UPDATED_NAME)
    ...
    public void initTest() {
        commonCondition = createEntity(em);
    }
    ...
    public void getAllCommonConditions() throws Exception {
        ...
        commonConditionRepository.saveAndFlush(commonCondition);
    ...
    public void getAllCommonConditionsByItemsIsEqualToSomething() throws Exception {
        // Initialize the database
        commonConditionRepository.saveAndFlush(commonCondition);
        CommonConditionItem items = CommonConditionItemResourceIT.createEntity(em);
        em.persist(items);
        em.flush();
    ...
    void putNewCommonCondition() throws Exception {
        ...
        em.detach(updatedCommonCondition);
