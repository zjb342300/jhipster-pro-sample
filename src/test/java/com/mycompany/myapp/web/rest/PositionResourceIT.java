...
public class PositionResourceIT {
    ...
    void createPosition() throws Exception {
        ...
        restPositionMockMvc
            .perform(
                post(ENTITY_API_URL_ID, positionDTO.getId())
    ...
    @Test
    @Transactional
    public void getAllPositionsByUsersIsEqualToSomething() throws Exception {
        // Initialize the database
        positionRepository.saveAndFlush(position);
    ...
    @Test
    @Transactional
    void putNonExistingngPosition() throws Exception {
        int databaseSizeBeforeUpdate = positionRepository.findAll().size();
    ...
    void partialUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.name(UPDATED_NAME).sortNo(UPDATED_SORT_NO);
