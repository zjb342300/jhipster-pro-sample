...
public class BusinessTypeResourceIT {
    ...
    void createBusinessType() throws Exception {
        ...
        restBusinessTypeMockMvc
            .perform(
                post(ENTITY_API_URL_ID, businessTypeDTO.getId())
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.saveAndFlush(businessType);
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByCodeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.saveAndFlush(businessType);
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.saveAndFlush(businessType);
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByIconIsNotEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.saveAndFlush(businessType);
    ...
    @Test
    @Transactional
    void putNewBusinessType() throws Exception {
        // Initialize the database
        businessTypeRepository.saveAndFlush(businessType);
    ...
    @Test
    @Transactional
    void putNonExistingngBusinessType() throws Exception {
        int databaseSizeBeforeUpdate = businessTypeRepository.findAll().size();
        businessType.setId(count.incrementAndGet());
    ...
    void partialUpdateBusinessTypeWithPatch() throws Exception {
        ...
        partialUpdatedBusinessType.description(UPDATED_DESCRIPTION).icon(UPDATED_ICON);
