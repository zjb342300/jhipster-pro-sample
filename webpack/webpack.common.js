...
module.exports = merge({
  ...
  module: {
    rules: [
      ...
      {
        test: /\.svg$/,
        include: [resolve('src/main/webapp/app/assets')],
        oneOf: [
          {
      ...
      },
      {
        ...
        loader: 'url-loader',
        exclude: [resolve('src/main/webapp/app/assets')],
        options: {
          esModule: false,
          limit: 10000,
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: './src/main/webapp/app/assets/', to: 'assets/' },
        { from: './src/main/resources/static/avatar/', to: 'avatar/' },
        { from: './src/main/resources/static/jslib/', to: 'jslib/' },
        {
